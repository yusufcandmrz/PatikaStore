...
export default function App() {
    ...
    return (
      <View style={styles.itemContainer}>
        ...
        <View style={styles.itemInfo}>
          ...
          {!item.inStock && <Text style={styles.itemInStock}>STOKTA YOK</Text>}
        </View>
      </View>
    );
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.searchBar} defaultValue="Ara..." editable={false}></TextInput>
      <FlatList style={styles.flatList} data={jsonData} renderItem={renderItem} numColumns={2} />
    </View>
  );
}
